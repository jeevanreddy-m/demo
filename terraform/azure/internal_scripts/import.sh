...
terraform import -var-file="terraform.tfvars.json" module.resource-group.azurerm_resource_group.rg /subscriptions/9bf7ac78-0625-49e4-9fe2-4f36dd943a48/resourceGroups/github-terraform-rg1 -auto-approve
